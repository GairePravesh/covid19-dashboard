...
function load_report() {
    ...
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            ...
            document.getElementById("n_daily_confirmed_label").innerText = addCommas(data.n_num_confirmed);
            document.getElementById("n_daily_recovered_label").innerText = addCommas(data.n_num_recovered);
            document.getElementById("n_daily_deaths_label").innerText = addCommas(data.n_num_deaths);
            document.getElementById("n_daily_death_rate_label").innerText = data.n_death_rate;

            document.getElementById("p_daily_new_label").innerText = addCommas(data.p_num_new);
            document.getElementById("p_daily_recovered_label").innerText = addCommas(data.p_num_recovered);
            document.getElementById("p_daily_deaths_label").innerText = addCommas(data.p_num_deaths);
            document.getElementById("p_daily_pcr_label").innerText = addCommas(data.p_num_pcr);
            document.getElementById("p_daily_rdt_label").innerText = data.p_num_rdt;
        }
    };
...
function load_trends() {
    ...
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            ...
            n_trend_confirmed_label = document.getElementById("n_trend_confirmed_label");
            n_trend_recovered_label =  document.getElementById("n_trend_recovered_label");
            n_trend_deaths_label = document.getElementById("n_trend_deaths_label");
            n_trend_death_rate_label = document.getElementById("n_trend_death_rate_label");
            ...
            if (data.n_confirmed_trend > 0) {
                n_trend_confirmed_label.innerHTML = "<i class='fa fa-angle-up'></i>";
                n_trend_confirmed_label.classList.add("text-danger");
            }
            else {
                n_trend_confirmed_label.innerHTML = "<i class='fa fa-angle-down'></i>";
                n_trend_confirmed_label.classList.add("text-success");
            }

            if (data.n_recovered_trend > 0) {
                n_trend_recovered_label.innerHTML = "<i class='fa fa-angle-up'></i>";
                n_trend_recovered_label.classList.add("text-success");
            }
            else {
                n_trend_recovered_label.innerHTML = "<i class='fa fa-angle-down'></i>",
                n_trend_recovered_label.classList.add("text-danger");
            }

            if (data.n_deaths_trend > 0) {
                n_trend_deaths_label.innerHTML = "<i class='fa fa-angle-up'></i>";
                n_trend_deaths_label.classList.add("text-danger");
            }
            else {
                n_trend_deaths_label.innerHTML = "<i class='fa fa-angle-down'></i>";
                n_trend_deaths_label.classList.add("text-success");
            }

            if (data.n_death_rate_trend > 0) {
                n_trend_death_rate_label.innerHTML = "<i class='fa fa-angle-up'></i>";
                n_trend_death_rate_label.classList.add("text-danger");
            }
            else {
                n_trend_death_rate_label.innerHTML = "<i class='fa fa-angle-down'></i>";
                n_trend_death_rate_label.classList.add("text-success");
            }
            ...
            n_trend_confirmed_label.innerHTML += " " + data.n_confirmed_trend + "%";
            n_trend_recovered_label.innerHTML += " " + data.n_recovered_trend + "%";
            n_trend_deaths_label.innerHTML += " " + data.n_deaths_trend + "%";
            n_trend_death_rate_label.innerHTML += " " + data.n_death_rate_trend;
        }
    };
